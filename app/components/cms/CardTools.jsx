      ...
      <div className="flex flex-col items-center space-y-4">
        ...
        <>
          ...
          <div className="grid grid-cols-2 gap-x-4 gap-y-2 w-full text-nowrap mx-2 ">
            ...
            <DraggableButton ref={ref => { if (ref) connectors.create(ref, <ImageUpload src="/simple-blue.png"  alt="" width={0} height={0} overlayOpacity={0} />); }} className="p-2 btn-gradient rounded text-center">Image Upload</DraggableButton>
