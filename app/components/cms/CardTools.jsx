...
export const CardTools = () => {
    ...
    const [selectedIcon, setSelectedIcon] = useState('BeakerIcon');
        ...
        <div className="pt-10">
            <div className="flex flex-col items-center space-y-2">
                ...
                <div className="flex justify-center items-center w-fit h-auto gap-2 text-sm border-0 border-b-2 border-white pb-8">
                    <DraggableButton ref={ref => { if (ref) connectors.create(ref, <OneColumnContainer background="#fff" padding={10} />); }} className="btn-gradient p-2 rounded text-center"><Square className='text-gray-950' size={32} /></DraggableButton>
                ...
                <div className="grid grid-cols-2 gap-x-4 gap-y-2 w-fit text-nowrap mx-2 ">
                    ...
                    <div className="flex flex-col items-center">
                        <label className="font-semibold text-sm underline text-white">Select Icon</label>
                        <select
                            value={selectedIcon}
                        ...
                        <DraggableButton ref={ref => { if (ref) connectors.create(ref, <IconsComponent icon={selectedIcon} />); }} className="p-2 btn-gradient rounded text-center">Icon</DraggableButton>
                    </div>
                </div>
            </div>
        </div>
