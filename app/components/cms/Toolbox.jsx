        ...
        <div className="pt-10">
            <div className="flex flex-col items-center space-y-2">
                ...
                <div className="flex justify-center items-center w-fit h-auto gap-2  text-sm">
                    <DraggableButton ref={ref => { if (ref) connectors.create(ref, <Container padding={20} background="#fff" canvas>{null}</Container>); }} className="p-2 btn-gradient rounded text-center"><Square className='text-gray-950' size={32} /></DraggableButton>
                    ...
                    <DraggableButton ref={ref => { if (ref) connectors.create(ref, <ThreeColumnContainer background="#fff" padding={20} />); }} className="btn-gradient p-2 justify-items-center grid grid-cols-3 rounded"><Square className='text-gray-950' size={32}/><Square className='text-gray-950' size={32} /><Square className='text-gray-950' size={32} /></DraggableButton>
                </div>
                <span className="text-lg font-medium text-gray-100 pt-2">Components</span>
                    ...
                    <DraggableButton ref={ref => { if (ref) connectors.create(ref, <Card background="#fff" padding={20} text="Card content" />); }} className="btn-gradient py-1 px-2 rounded text-gray-950">Card</DraggableButton>
