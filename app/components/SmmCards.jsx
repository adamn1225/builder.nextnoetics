            ...
            {selectedCard === 'Facebook' && (
              <Frame>
                <Element is={FbContainer} canvas>
                  <Element is={Post} background={"#fff"} containerType="facebook" />
                </Element>
              </Frame>
            )}
            {selectedCard === 'Instagram' && (
              <Frame>
                  <div style={{ display: 'flex', justifyContent: 'center', alignContent: 'center', transform: 'scale(0.5)', transformOrigin: 'top', height: '100%', width: '100%' }}>
                    <Element is={IgContainer} canvas>
                      <Element is={Post} background={"#fff"} containerType="instagram" />
                    </Element>
                  </div>
              </Frame>
            )}
